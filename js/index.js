            ...
            return {
                ...
                chooseShop: function (){
                    ...
                    var $csShop = $('#cs-shop'),
                        ...
                        $countPrice = $('#price > p > [class="num"]'),
                        $price1 = $countPrice.eq(0), //price1 
                        $price2 = $countPrice.eq(1),
                        $price3 = $countPrice.eq(2),
                        ...
                        function needMoney(sum) {
                            if (sum >1 && sum <100) {
                                curPrice($price1);
                                return  (sum * 0.5).toFixed(2);
                            } else if (sum >=100 && sum < 1000) {
                                curPrice($price2);
                                return (sum * 0.45).toFixed(2);
                            } else if (sum >= 1000 ) {
                                curPrice($price3);
                                return (sum * 0.4).toFixed(2);
                            }else {
                                $countPrice.removeClass('curPrice');
                                return 1 + '.00';
                            }
                        }
                        
                        // 重复用到的代码，封装成一个函数
                        function curPrice (obj) {
                            obj.addClass('curPrice').parent()
                               .siblings('p').children().removeClass('curPrice');
                        }
